...
namespace LoginTests
{
    [TestFixture]
    [AllureNUnit]
    public class CreateAccountTestsFirefox
    {
            ...
            public void Open()
            {
                driver = new RemoteWebDriver(new Uri("https://oauth-antondarovski97-bf9e3:19b6c1c4-5127-4d25-b46e-d1f8419358ca@ondemand.eu-central-1.saucelabs.com:443/wd/hub"), GetFirefoxOptions().ToCapabilities(), TimeSpan.FromSeconds(60));
            }
            ...
            private FirefoxOptions GetFirefoxOptions()
            {
                ...
                firefoxOptions.AddAdditionalOption("username", "oauth-antondarovski97-bf9e3");
                firefoxOptions.AddAdditionalOption("accessKey", "*****58ca");
        ...
        public void UITest(Action action)
        {
            ...
            catch (Exception ex)
            {
                ...
                ICapabilities caps1 = ((FirefoxDriver)driver).Capabilities;
